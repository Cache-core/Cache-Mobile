                ...
                <View style={styles.depositItemData}>
                  <View style={styles.depositData}>
                    ...
                    <View style={styles.depositItemWrapper}>
                      ...
                      <Text style={styles.depositItemValue}>{(item.amount / appSettings.coinMetrics).toLocaleString(undefined, formatOptions)} CXCHE</Text>
                    </View>
                    <View style={styles.depositItemWrapper}>
                      <Text style={styles.depositItemLabel}>Interest:</Text>
                      <Text style={styles.depositItemValue}>{(item.interest / appSettings.coinMetrics).toLocaleString(undefined, formatOptions)} CXCHE</Text>
                    </View>
