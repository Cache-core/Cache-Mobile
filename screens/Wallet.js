      ...
      {currWallet
            ...
            <View style={styles.walletState}>
              ...
              >
                <View style={styles.walletStateWrapper}>
                  ...
                  <Text style={styles.amountCCX}>{currWallet.balance.toLocaleString(undefined, format4Decimals)} CXCHE</Text>
                  <View style={styles.btcPriceWrapper}>
                    ...
                    <Text style={currWallet.locked ? [styles.worthBTC, styles.lockedText] : styles.worthBTC}>
                      {
                        currWallet.locked
                          ? sprintf('%s CXCHE', currWallet.locked.toLocaleString(undefined, format4Decimals))
                    ...
                    <View style={styles.flatview}>
                      <View style={styles.txData}>
                        ...
                        <Text style={styles.dataAmount}>
                          {item.amount.toLocaleString(undefined, formatOptions)} CXCHE (fee: {item.fee})
                          </Text>
        ...
        (<View style={styles.emptyWalletWrapper}>
          <Text style={styles.emptyWalletText}>
            You have no active wallets. Please create a one to start using Cache Mobile
          </Text>
          <ConcealButton
